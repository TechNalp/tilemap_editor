    ...
    <div id="side-menu" v-bind:class="['position-relative flex-column h-100', (show !== null ? 'd-flex' : 'd-none')]">
        ...
        <div class="h-100 w-100">
            <div class="mx-2">
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist" ref="tabs">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="layout-tab" data-bs-toggle="tab" data-bs-target="#layout-tab-pane" type="button" role="tab" aria-controls="layout-tab-pane" aria-selected="false">Layouts</button>
                </li>

                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="properties-tab" data-bs-toggle="tab" data-bs-target="#properties-tab-pane" type="button" role="tab" aria-controls="properties-tab-pane" aria-selected="false" @click="recupereInfoProperties">Properties</button>
                </li>
              </ul>

              <div class="tab-content" id="myTabContent">

                <div class="tab-pane fade show active" id="tileset-tab-pane" role="tabpanel"
                     aria-labelledby="tilset-tab" tabindex="0">
                  <tileSetTab/>
                </div>
                ...
                <div class="tab-pane fade" id="properties-tab-pane" role="tabpanel" aria-labelledby="properties-tab"
                     tabindex="0">
                  <properties-tab/>
                </div>
